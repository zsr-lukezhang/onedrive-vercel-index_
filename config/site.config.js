...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@lukezhang.onmicrosoft.com',
  ...
  title: "Luke Zhang's Shared Drive",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/zsr-lukezhang/',
    },
  ],
